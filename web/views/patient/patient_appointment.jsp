        ...
        <main class="main-content">
            ...
            <form action="<%= request.getContextPath()%>/appointment" method="post" class="filter">
             ...
             <!-- Dùng nếu muốn giữ value của lịch value="<%= request.getAttribute("selectedDate") != null ? request.getAttribute("selectedDate") : ""%>"-->
                ...
                <a href="<%= request.getContextPath()%>/book-appointment"
                   class="btn-nearest" style="gap:5px; margin-left:auto;">
                    <!-- SVG icon + -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<%= request.getContextPath()%>/record?appointment_id=<%= appt.getAppointmentId()%>"
                               class="btn-detail">
                                Xem
                            </a>
                            <% } else { %>
