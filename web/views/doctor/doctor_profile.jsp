...
<head>
    ...
    <style>
        ...
        .main { flex: 1; width: 100%; max-width: 1100px; margin: 0 auto; padding-bottom: 60px; }
...
<body>
    ...
    <div class="main">
        <div class="content-wrapper">
            ...
            <% if ("updated".equals(msg)) { %><div class="alert alert-success alert-dismissible fade show">Cập nhật thành công! <button type="button" class="btn-close" data-bs-dismiss="alert"></button></div><% } %>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="profile-header-card">
                        ...
                        <div class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill mb-4">Bác sĩ</div>
                        <hr>
                    ...
                    <div class="profile-form-card">
                        ...
                        <form action="${pageContext.request.contextPath}/doctor/profile" method="post">
                            ...
                            <div class="mt-4 text-end">
                               <a href="${pageContext.request.contextPath}/doctor/change-password" class="btn btn-outline-secondary me-2">
