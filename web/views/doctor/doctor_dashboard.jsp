        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                <div class="welcome-card mb-4 animate__animated animate__fadeInLeft">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-center d-none d-md-block">
                            <i class="fa-solid fa-user-doctor" style="font-size: 80px; opacity: 0.9;"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        <div class="stat-card">
                            <div class="icon-box bg-icon-blue"><i class="fa-solid fa-calendar-check"></i></div>
                            <h3 class="fw-bold mb-1"><%= shiftCount %></h3>
                            <p class="text-muted small mb-0">Ca trực tháng này</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stat-card">
                    ...
                    <div class="card-body">
                        ...
                        <% if (todayShifts.isEmpty()) { %>
                            <div class="text-center py-5 text-muted">
                                ...
                                <p>Hôm nay bạn không có ca trực nào.</p>
                            </div>
                        <% } else { 
                        ...
                        <div class="alert alert-info bg-opacity-10 border-0 rounded-3 mt-4">
                            <small><i class="fa-solid fa-circle-info me-1"></i> Hệ thống tự động cập nhật trạng thái trực dựa trên giờ hiện tại.</small>
                        </div>
                    </div>
                </div>
            </div>
