...
<head>
    ...
    <title>Lịch sử cuộc hẹn bác sĩ</title>
...
<body>
<%
    request.setAttribute("currentPage", "doctor_appointments");
%>
<jsp:include page="/views/shared/doctor_header.jsp" />

<main class="main-content">
    <div class="title-box"><h3>DANH SÁCH LỊCH SỬ CUỘC HẸN</h3></div>
...
%>
        <tr>
            <td colspan="8" style="text-align:center; font-size: 1rem;">Không có lịch hẹn nào.</td>
        </tr>
<%
    }
%>
